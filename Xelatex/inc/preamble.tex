...
\hypersetup{
    ...
    pdfauthor={Максим Прудников},
    pdftitle={Особенности портирования настольного программного обеспечения в веб на примере С++ приложения для нахождения номенклатуры листа топокарты}
}
...
\renewcommand{\baselinestretch}{1.15} % Полуторный межстрочный интервал
